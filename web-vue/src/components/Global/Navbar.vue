  ...
  <header class="navbar" :class="{ sticky: isSticky }">
    <nav>
      <ul class="menu">
        ...
        <li><router-link to="/proyect-page">Proyectos</router-link></li>
          <li><a class="titimepregunto" href="#about-us">Sobre nosotros</a></li>
          <li><a class="titimepregunto" href="#contacto">Contacto</a></li>
          <li>
